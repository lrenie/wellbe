...
friendship2.status = "true"
friendship2.sender = users[0]
friendship2.recipient = users[3]
friendship2.save!

friendship2 = Friendship.new
friendship2.status = "true"
friendship2.sender = users[0]
friendship2.recipient = users[4]
friendship2.save!
...
friendship3.recipient = User.where(first_name: "corentin")
friendship3.save!

friendship4 = Friendship.new
friendship4.status = "true"
friendship4.sender = users[1]
friendship4.recipient = User.where(first_name: "Benoit")
friendship4.save!
